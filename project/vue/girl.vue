<template>
	<div id="recommended">
		<div class="boyHead">
			<div class="boyHead_a">
				<img :src="images" width="100%" @error="Err($event)">
				<span>总裁</span>
			</div>
			<div class="boyHead_a">
				<img :src="images" width="100%" alt=""  @error="Err($event)">
				<span>穿越</span>
			</div>
			<div class="boyHead_a">
				<img :src="images" width="100%" alt=""  @error="Err($event)">				
		...
		<div class="hotPush">
			...
			<div class="push">
				<router-link :to="'/details?id='+key.id" tag="div" v-for="key in list1" :key="key.index">
					<img :src="key.picture" width="100%" alt=""  @error="Err($event)">
					<div class="pushText">
		...
		<div class="theCity">
			...
			<div class="urbanNovels">
				<div class="urbanNovels_a" v-for="key in list1" :key="key.index">
                	<img :src="key.picture" width="100%" alt=""  @error="Err($event)">
					<div>
						<span>{{key.booksname}}</span>
						<span>{{key.descr}}</span>
    ...
    export default {
        ...
        methods:{
			...
			Err(e){
				...
				$(e.path[0]).attr('src','static/images/7.jpg')
			}
        }
	};
</script>
